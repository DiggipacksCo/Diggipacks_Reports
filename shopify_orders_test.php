...
$sql = "select c.id,c.*,cn.city as city_name from customer c left join country cn on c.city = cn.id where c.deleted='N' and c.is_shopify_active ='1' and c.shopify_url !='' and c.id=36";
...
if ($query->num_rows > 0) {
    while ($row = mysqli_fetch_assoc($query)) {
     ...
     echo '<br>'.   $url = 'https://a6109ba9c121d11d30a57491e7b4ff5e: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@silkyskinsa.myshopify.com/admin/api/2021-04/orders/4619428626658.json';
    ...
    function getOrders($url, $customer) {
        ...
        $order = json_decode($orders)->order;
