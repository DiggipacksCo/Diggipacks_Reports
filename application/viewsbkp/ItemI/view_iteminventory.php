                                    ...
                                    <table class="table table-striped table-hover table-bordered dataTable bg-*" id="printTable" style="width:100%;">
                                        ...
                                        <tbody id="">
                                            ...
                                            <tr ng-if='shipData != 0' ng-repeat="data in shipData">
                                                ...
                                                <td>{{data.sku_size}}</td>
                                                <td><img ng-if="data.item_path != ''" src="https://fm.diggipacks.com/{{data.item_path}}" width="100">
                                                    <img ng-if="data.item_path == ''" src="https://fm.diggipacks.com/assets/nfd.png" width="100">
                                                </td>
