 ...
 <!-- <th>Category</th> -->
                                        ...
                                        <tbody>
                                            ...
                                            <tr ng-if="shipData != 0" ng-repeat="data in shipData">
                                                ...
                                                <td><img ng-if="data.item_path != ''" src="https://fm.diggipacks.com/{{data.item_path}}" width="65">
                                                    <img ng-if="data.item_path == ''" src="https://fm.diggipacks.com/assets/nfd.png" width="65"></td>
                                                <td>
                                              ...
                                              <td>   <!--<a href="<?= base_url(); ?>Item/edit_view/{{data.id}}"></a>-->{{data.name}}</td> 
                                                <td>{{data.sku}}</td>
                                                <td>{{data.wh_name}}</td>
