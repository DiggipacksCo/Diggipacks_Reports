...
<div class="col-md-4"><div class="form-group" ><strong></strong><br/><button type="submit"  class="btn btn-danger"- ><?= lang('lang_Get_Details'); ?></button>
              ...
              <!-- <input type="text" id="search"  placeholder="Search .." class="form-control">
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($sellers)) {
                                                ...
                                                foreach ($sellers as $seller) {
                                                    ...
                                                    $running = GetdeliveryreportArr($seller->id, 'running');
                      ...
                      <td><a href="' . base_url() . 'performance_details_3pl/' . $seller->id . '/7/' . $from_date . '/' . $to_date . '" target="_blank"><span class="btn btn-success">' . $delivered . ' </span></a></td>
					  <td><a href="' . base_url() . 'performance_details_3pl/' . $seller->id . '/8/' . $from_date . '/' . $to_date . '" target="_blank"><span class="btn btn-danger">' . $Not_delivered . ' </span></a></td>
					<!--  <td><a href="' . base_url() . 'performance_details_3pl/' . $seller->id . '/running/' . $from_date . '/' . $to_date . '"><span class="btn btn-warning">' . $running . '</span></a> </td>-->
