                                    ...
                                    <form  id="exportfrom" name="exportfrom" action="<?=base_url();?>/Bulkdownload/export" method="post" onsubmit="document.getElementById('Newaddfrm').disabled=true; processFormData();" target="_blank">
                                        ...
                                        <div class="panel-body" >
                                            <div class="col-lg-12" style="padding-left: 20px;padding-right: 20px;">
                                                ...
                                                <div class="col-md-2"><div class="form-group" ><strong><?= lang('lang_Payment_Mode'); ?>:</strong><br/>
                                            ...
                                            <div class="col-md-2"><div class="form-group" ><strong>Back Order:</strong><br/>
                                            ...
                                            <option value="0">No</option>
                                                ...
                                                <div class="col-md-2"> 
                                                    <div class="form-group" ><strong><?= lang('lang_From'); ?>:</strong>
                                                        <input class="form-control date" id="from" name="from"  placeholder="From Create Date" ng-model="filterData.from" class="form-control"> 

                                                    </div> 
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group" ><strong><?= lang('lang_To'); ?>:</strong>
                                                        <input class="form-control date" id="to" name="to"  placeholder="To Create Date" ng-model="filterData.to" class="form-control"> 

                                                    </div>
                                                </div>

                                                <div class="col-md-2">  <div class="form-group" ><strong><?= lang('lang_Main'); ?>  <?= lang('lang_Status'); ?>:</strong>
                                                        <br>
