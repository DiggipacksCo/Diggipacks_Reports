...
<!--                                                            <option value="SKU">SKU</option>-->
                                                ...
                                                <div class="col-md-3"><div class="form-group" ><strong>Warehouse:</strong> <br>
                                                        ...
                                                        //print_r($destData);
                                                        ?>
                                                        <select  id="destination" name="destination"  ng-model="filterData.wh_id"  data-show-subtext="true" data-live-search="true" class="selectpicker" data-width="100%" >
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Select Picker (Optional) </h5>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" ng-click="generatePickup(picker_id);" >Confrim Generate Pickup</button>
                                    </div>
                                    </form>          
                                </div>
                            </div>
