                                    ...
                                    <!-- href="<? //base_url('Pdf_export/all_report_view');     ?>" --> 
                                        ...
                                        <div class="panel-body" >
                                            <div class="col-lg-12" style="padding-left: 20px;padding-right: 20px;"> 
                                                ...
                                                <!-- <div class="panel-body" > -->
                                                <div class="col-md-3"><div class="form-group" ><strong>Select Type:</strong> 
...
<!--                                                            <option value="SKU">SKU</option>-->
                                                ...
                                                <div class="col-md-3" style="margin-top: 10px;"> <div class="form-group" ><strong>To:</strong>
                                                        <input type="date" id="to"name="to"  ng-model="filterData.to" class="form-control">
                                                    </div></div>
                                                
                                                <div class="col-md-2"> <div class="form-group" ><strong>3PL Company:</strong>
                                                ...
                                                <div class="col-md-2"><div class="form-group" ><strong>Is Menifest</strong> 
                                                        <select   ng-model="filterData.is_manifest" class="form-control"  data-width="100%" >
                                                            <option value="">Is Menifest</option>
                                                 ...
                                                 <div class="col-md-6"><div class="form-group" ><button  class="btn btn-danger ml-10" ng-click="loadMore(1, 1);" >Search</button>
                                                        <button type="button" class="btn btn-success ml-10" >Total <span class="badge">{{shipData.length}}/{{totalCount}}</span></button>
                                                        <button  class="btn btn-info ml-10" ng-click="createManifest();" >Create Manifest</button></div></div>
