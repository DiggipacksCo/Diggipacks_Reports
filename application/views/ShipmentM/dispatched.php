                                    ...
                                    <!-- href="<? //base_url('Pdf_export/all_report_view');     ?>" --> 
                                        ...
                                        <div class="panel-body" >
                                            <div class="col-lg-12" style="padding-left: 20px;padding-right: 20px;"> 
                                                ...
                                                <!-- <div class="panel-body" > -->
                                                <div class="col-md-3"><div class="form-group" ><strong><?=lang('lang_SelectType');?>:</strong> 
                                                        <select  id="s_type" name="s_type" ng-model="filterData.s_type" class="form-control"  data-width="100%" >
...
<!--                                                            <option value="SKU">SKU</option>-->
                                                ...
                                                <div class="col-md-3"><div class="form-group" ><strong><?=lang('lang_warehouse');?>:</strong> 
                                                        <?php
                                                ...
                                                <div class="col-md-3" style="margin-top: 10px;"> <div class="form-group" ><strong><?=lang('lang_To');?>:</strong>
                                                        <input type="date" id="to"name="to"  ng-model="filterData.to" class="form-control">
                                                    </div></div>
                                                
                                                <div class="col-md-2"> <div class="form-group" ><strong><?=lang('lang_TPL_company');?>:</strong>
                                                ...
                                                <div class="col-md-2"><div class="form-group" ><strong><?=lang('lang_is_manifest');?></strong> 
                                                        <select   ng-model="filterData.is_manifest" class="form-control"  data-width="100%" >
                                                            <option value=""><?=lang('lang_is_manifest');?></option>
                                                            <option value="1"><?=lang('lang_Yes');?></option>
                                                            <option value="0"><?=lang('lang_No');?></option>
                                                        </select>
                                                    </div></div>
                                                 ...
                                                 <div class="col-md-6"><div class="form-group" ><button  class="btn btn-danger ml-10" ng-click="loadMore(1, 1);" ><?=lang('lang_Search');?></button>
                                                        ...
                                                        <button  class="btn btn-info ml-10" ng-click="createManifest();" ><?=lang('lang_Create_Manifest');?></button></div></div>
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="row" style="padding-left: 40%;padding-top: 10px;">   
                                                ...
                                                <button type="submit" class="btn btn-info pull-left" name="shipment_transfer" ng-click="transferShipDispatched(listData2, listData1.exportlimit);"><?= lang('تحميل تقرير الاكسل'); ?></button>  
                                            </div>
