...
<!--                                                                        <option value="SKU">SKU</option>-->
                      ...
                      <select  id="destination" name="destination"  ng-model="filterData.wh_id"  class="selectpicker" data-width="100%" >
                        ...
                        <?php endforeach;?>
                                                ...
                                                <div class="col-md-3"><div class="form-group" ><button  class="btn btn-danger ml-10" ng-click="loadMore(1, 1);" >Search</button>
                    ...
                    <div class="modal-body">
                         <div class="row">
						  ...
						  <div class="col-md-12 row">
							...
							<div class="col-sm-4">   
                                        <label class="container">
                                            <input type="checkbox" name="entrydate" value="entrydate" ng-checked="checkall" ng-model="listData2.frwd_company"> Forward Company
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
									<div class="col-sm-4">   
                                        <label class="container">
                                            <input type="checkbox" name="entrydate" value="entrydate" ng-checked="checkall" ng-model="listData2.frwd_company_awb"> Forward Company AWB No
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
							   <div class="col-sm-4">
                                ...
                                <div class="row" style="padding-left: 40%;padding-top: 10px;">   
                                    ...
                                    <button type="submit" class="btn btn-info pull-left" name="shipment_transfer" ng-click="transferShipPacked(listData2, listData1.exportlimit);"><?=lang('تحميل تقرير الاكسل');?></button>  
                                </div>
