...
<html lang="en">
    ...
    <body ng-app="Appiteminventory">
        ...
        <!-- Page container -->
        <div class="page-container" ng-controller="CtritemInvontaryview" ng-init="loadMore_damage(1, 0);">  
                            ...
                            <div class="col-lg-12" > 
                                ...
                                <div class="panel panel-flat" >
                                    <div class="panel-heading">
                                        <h1><strong>Show Damage Item</strong>
                                            ...
                                            <table class="table table-bordered table-hover" style="width: 100%;">
                                                ...
                                                <tbody >
                                                    ...
                                                    <tr style="width: 80%;">
                                                        ...
                                                        <td colspan="1"> <button  class="btn btn-danger" ng-click="loadMore_damage(1, 1);" style="margin-left: 7%" >Search</button></td>
                                                        
                                                        <td colspan="1" ng-if="Items.length>0"> <button  class="btn btn-danger" ng-click="GetCheckReturnOrderProcesspop();" style="margin-left: 7%" >Create Order Return</button></td>
...
<td>{{data.sku}}</td>
                                    ...
                                    <button ng-hide="shipData.length == totalCount" class="btn btn-info" ng-click="loadMore_damage(count = count + 1, 0);" ng-init="count = 1">Load More</button>
                                </div>
