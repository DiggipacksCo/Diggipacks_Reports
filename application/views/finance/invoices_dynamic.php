    ...
    <table class="table table-bordered table-hover" style="width: 100%;">
      ...
      <tbody >
        <tr style="width: 80%;">
          ...
          <td><button  class="btn btn-danger" ng-click="dynamicinvoiceReport(1,1);" >Get Details</button></td>
           <td>
          <a class="btn btn-danger" ng-click = "run_shell_dynamic();" target="_blank" >Sync</a>
          ...
          <td class="text-center"><ul class="icons-list">
              <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-menu9"></i> </a>
                <ul class="dropdown-menu dropdown-menu-right">
                  ...
                  <li ><a  href="<?=base_url();?>viewinvoice_dynamic/{{data.invoice_no}}"><i class="icon-eye" ></i>  View Invoice </a></li>
                </ul>
              </li>
            </ul></td>
            <td>
