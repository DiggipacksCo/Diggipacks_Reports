                ...
                <div class="content-wrapper">
                    ...
                    <div class="content">
                        <div class="panel panel-flat">
                            <div class="panel-heading"><h1><strong>Add User</strong></h1></div>
                            <hr>
                            <div class="panel-body">
                                ...
                                <form action="<?= base_url('Users/add'); ?>" name="adduser" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="radio" name="system_access" id="system_access" value="Y">  Yes <input type="radio" name="system_access" id="system_access1" checked="" value="N">  No
                                    </div>
                                    <div class="form-group">
